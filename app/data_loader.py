"""
Data loading utilities for the NBA Mock Draft 2026 application.
...
def load_teams() -> dict[str, Team]:
    """
    Load all NBA teams from data/teams.json and index by abbreviation.
...
def get_enriched_picks_by_round(round_number: int) -> list[EnrichedPick]:
    ...
    Args:
        round_number (int): Round number to filter (1 or 2).
